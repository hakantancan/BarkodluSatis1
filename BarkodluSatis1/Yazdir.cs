...
namespace BarkodluSatis1
{
    internal class Yazdir
    {
        ...
        private void Pd_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            var liste=db.Satis.Where(x=> x.IslemNo==IslemNo).ToList();                                //Db'deki işlem no == dışarıdan gelen işlem no ise bunu listele
            if (isyeri!=null && liste!=null)
            {
                ...
                PaperSize ps58 = new PaperSize("58mm Termal", 220, kagituzunluk + 120);                               //standart termal yazıcıda Kağıt boyutu 
                pd.DefaultPageSettings.PaperSize = ps58;

                Font fontBaslik=new Font("Calibri",10,FontStyle.Bold);                                //Başlık kısmı ayarlaması
                ...
                e.Graphics.DrawString("Değeri Yoktur", fontBilgi, Brushes.Black, new Point(5, yukseklik + 60));
